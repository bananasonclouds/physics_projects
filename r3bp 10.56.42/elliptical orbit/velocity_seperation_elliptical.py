...
def run_runge(m1, m2, m3, t_max, dt):
    ...
    return x1s, y1s, x2s, y2s, x3s, y3s, vx3s, vy3s

# Parameters for the simulation
t_max = 365 * 24 * 3600 * 20  # 5 years
dt = 150 # 1 day

# Run the simulation
x1s, y1s, x2s, y2s, x3s, y3s, vx3s, vy3s = run_runge(m1, m2, m3, t_max, dt)

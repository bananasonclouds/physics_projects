...
def run_runge(m1, m2, m3,times, dt):
    r = 0.1* pow(10, 11)  # Initial separation between stars, 1 AU for simplicity
    r_planet = 0.7 * 1.5 * pow(10, 11) #* perturbation_factor  # Initial distance of the planet from the system's center of mass

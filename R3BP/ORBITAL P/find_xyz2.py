...
elements = open('/Users/mac/Desktop/ORBITAL P/test','r')
minor = EllipticalBody()
minor._epoch = '2000/01/01.5'   # epoch date for J2000.0
ele = np.genfromtxt('/Users/mac/Desktop/ORBITAL P/test',dtype=None)
...
durham.temp = 10
durham.elev = 119.5
durham.date =  '2022-10-10 20:30:00' #year+'/'+month+'/'+day+ ' '+obstime 
#print(durham.date)
...
#print (durham.date, "%7.5f" % d_minor, "%7.5f" % (180./math.pi*ecl_long_minor), "%7.5f" % (180./math.pi*ecl_lat_minor), "%7.5f" % x_minor, "%7.5f" %  y_minor, "%7.5f" % z_minor,  "%7.5f" % d_sun, "%7.5f" % (180./math.pi*ecl_long_sun), "%7.5f" % (180./math.pi*ecl_lat_sun), "%7.5f" % x_sun, "%7.5f" %  y_sun, "%7.5f" % z_sun)
print (durham.date)
print("%7.5f" % d_minor) #distance to asteroid
print("%7.5f" % (180./math.pi*ecl_long_minor)) #ecpliptic longitude of asteroid
print("%7.5f" % (180./math.pi*ecl_lat_minor)) #ecpliptic latitude of asteroid
print("%7.5f" % x_minor,"%7.5f" %  y_minor, "%7.5f" % z_minor) #x,y,z of asteroid
print( "%7.5f" % d_sun, "%7.5f" % (180./math.pi*ecl_long_sun), "%7.5f" % (180./math.pi*ecl_lat_sun)) #Sun's position relative to the observer
print("%7.5f" % x_sun, "%7.5f" %  y_sun, "%7.5f" % z_sun) #x,y,z of sun
